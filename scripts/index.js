...
const placeTitleInput = formElementPlace.querySelector(".popup__input_value_placeTitle");
const placeImageUrl = formElementPlace.querySelector(".popup__input_value_placeImageLink");
...
function profileFormSubmit() {
    ...
    api.editUserInfo(profileNameInput, profileAboutInput)
        .then((result) => {
            console.log(result);
...
function newPlaceFormSubmit() {
    ...
    api.postNewCard(placeTitleInput, placeImageLinkInput)
        .then((result) => {
...
const profilePopUp = new PopupWithForm(".popup_type_editProfile", profileFormSubmit);

const newPlacePopUp = new PopupWithForm(".popup_type_newPlace", newPlaceFormSubmit);

const newAvatarPopUp = new PopupWithForm(".popup_type_newAvatar", newAvatarFormSubmit);
